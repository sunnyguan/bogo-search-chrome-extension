...
<div class="instructions">Choose topics (optional):</div>
<div class="dropdown-container">
    <div class="dropdown-button noselect">
        <div class="dropdown-label">Departments</div>
        <div class="dropdown-quantity">(<span class="quantity">All</span>)</div>
        <i class="fa fa-filter"></i>
    </div>
    <div class="dropdown-list" style="display: none;">
        <input type="search" placeholder="Search Departments" class="dropdown-search"/>
        <ul id="topic-select"></ul>
    </div>
</div>
